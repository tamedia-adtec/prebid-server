...
func SetupViper(v *viper.Viper, filename string, bidderInfos BidderInfos) {
	...
	v.SetDefault("external_url", "dev-prebid.da-services.ch")
	v.SetDefault("host", "")
	...
	v.SetDefault("gdpr.timeouts_ms.init_vendorlist_fetches", 5)
	v.SetDefault("gdpr.timeouts_ms.active_vendorlist_fetch", 2000)
